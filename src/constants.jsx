export const Cri3xFarm = '0x99e3E03bAEf393662224C4aF6e0623DF79b2d203';
export const Cri3xToken = '0x0579dF7951548b143b8533fF56028Fb1fb4Cf7c3';


export const Cri3xFarm_ABI = [
    {
    ...
    {
        anonymous: false,
        inputs: [ { indexed: false, internalType: "uint256", name: "maxBoost", type: "uint256" } ],
        name: "BoostUpdate",
        type: "event",
    },
    {
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: "uint256", name: "rewardTokenPerBlock", type: "uint256" },
            { indexed: false, internalType: "contract IERC20", name: "depositToken", type: "address" },
            { indexed: false, internalType: "contract IERC20", name: "rewardToken", type: "address" },
            { indexed: false, internalType: "bool", name: "with_update", type: "bool" },
        ],
        name: "NewPool",
        type: "event",
    },
    ...
    {
        inputs: [
            { internalType: "uint256", name: "_rewardTokenPerBlock", type: "uint256" },
    ...
    },
    {
        inputs: [
            ...
            { internalType: "uint256", name: "_lock_period", type: "uint256" },
        ],
        name: "deposit",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    },
    {
        inputs: [
            { internalType: "uint256", name: "_pid", type: "uint256" },
            { internalType: "address", name: "lockFor", type: "address" },
            { internalType: "uint256", name: "_amount", type: "uint256" },
            { internalType: "uint256", name: "_lock_period", type: "uint256" },
        ],
        name: "lockForSomeone",
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: "uint256", name: "rewardTokenPerBlock", type: "uint256" },
        ],
        stateMutability: "view",
        type: "function",
    },
    ...
    {
        inputs: [ { internalType: "uint256", name: "_max_boost", type: "uint256" } ],
        name: "setMaxBoost",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
